        ...
        <div className="py-4 add-vacancy-form px-[3.5rem]">
          ...
          >
            <div className="flex flex-col w-full gap-2">
              <label htmlFor="Openings">Image</label>
              <input
                type="file"
                id="Openings"
                {...register("Openings")}
            ...
            <div className="flex flex-col w-full gap-2">
              <label htmlFor="Openings">Title</label>
              <input
                type="text"
                id="Openings"
                {...register("Openings")}
            ...
            <div className="flex flex-col w-full gap-2">
              <label htmlFor="Openings">Duration</label>
              <input
                type="time"
                id="Openings"
                {...register("Openings")}
            ...
            <div className="flex flex-col w-full gap-2">
              <label htmlFor="Openings">City</label>
              <input
                type="text"
                id="Openings"
                {...register("Openings")}
            ...
            <div className="flex flex-col w-full gap-2">
              <label htmlFor="Openings">Country</label>
              <input
                type="text"
                id="Openings"
                {...register("Openings")}
            ...
            <div className="flex flex-col w-full gap-2">
              <label htmlFor="Openings">Amount</label>
              <input
                type="number"
                id="Openings"
                {...register("Openings")}
            ...
            <div className="flex flex-col w-full gap-2">
              <label htmlFor="Openings">Offer</label>
              <input
                type="number"
                id="Openings"
                {...register("Openings")}
            ...
            <div className="flex flex-col w-full gap-2">
              <label htmlFor="Openings">Offer Duration-days</label>
              <input
                type="number"
                id="Openings"
                {...register("Openings")}
            ...
            <div className="flex flex-col w-full gap-2">
              <label htmlFor="Openings">Pickup</label>
              <input
                type="boolean"
                id="Openings"
                {...register("Openings")}
            ...
            <div className="flex flex-col w-full gap-2">
              <label htmlFor="Openings">Pickup Time</label>
              <input
                type="time"
                id="Openings"
                {...register("Openings")}
            ...
            <div className="flex flex-col w-full gap-2">
              <label htmlFor="Openings">drop location</label>
              <input
                type="text"
                id="Openings"
                {...register("Openings")}
            ...
            <div className="flex flex-col w-full gap-2">
              <label htmlFor="Openings">Min member</label>
              <input
                type="number"
                id="Openings"
                {...register("Openings")}
            ...
            <div className="flex flex-col w-full gap-2">
              <label htmlFor="Openings">Max member</label>
              <input
                type="number"
                id="Openings"
                {...register("Openings")}
